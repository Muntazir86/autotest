...
def process_enhanced_options(
    ...
    if report_html_path:
        from schemathesis.cli.commands.run.handlers.html_report import HTMLReportHandler
    ...
    if extract_ids and not no_extract_ids:
        from schemathesis.cli.commands.run.handlers.id_extraction import IDExtractionHandler
