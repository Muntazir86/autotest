...
from autotest.schemas import APIOperation, OperationDefinition, PayloadAlternatives
from autotest.specs.openapi._hypothesis import jsonify_python_specific_types, quote_all
from autotest.specs.openapi.adapter import v2
from autotest.specs.openapi.adapter.parameters import (
    OpenApiBody,
    OpenApiParameter,
    OpenApiParameterSet,
...
def test_invalid_custom_strategy(values, error):
    with pytest.raises(TypeError) as exc:
        autotest.openapi.format(*values)
...
def test_optional_payload(ctx, version):
    ...
    # Then `None` could be generated by Autotest
