...
from autotest.checks import CHECKS, load_all_checks
from autotest.cli.commands.run import executor, validation
from autotest.cli.commands.run.filters import with_filters
from autotest.cli.constants import MAX_WORKERS, MIN_WORKERS
from autotest.cli.core import ensure_color
from autotest.cli.ext.groups import group, grouped_option
from autotest.cli.ext.options import (
    CsvChoice,
    CsvEnumChoice,
...
from autotest.core.transport import DEFAULT_RESPONSE_TIMEOUT
from autotest.generation import GenerationMode
from autotest.generation.metrics import METRICS, MetricFunction
...
@grouped_option(
    ...
    help="A comma-separated list of Autotest health checks to disable",
...
@grouped_option(
    "--generation-database",
    help="Storage for examples discovered by Autotest. "
...
def run(
    ...
    *,
    ...
    warnings: bool | list[AutotestWarning] | None,
    ...
    **__kwargs: Any,
    ...
    config: AutotestConfig = ctx.obj.config
