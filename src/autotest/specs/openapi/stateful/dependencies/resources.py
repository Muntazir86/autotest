...
from autotest.core.jsonschema.types import get_type
from autotest.specs.openapi.adapter.parameters import resource_name_from_ref
...
from autotest.specs.openapi.stateful.dependencies.models import (
...
from autotest.specs.openapi.stateful.dependencies.naming import from_path
from autotest.specs.openapi.stateful.dependencies.schemas import (
    ROOT_POINTER,
    canonicalize,
...
if TYPE_CHECKING:
    ...
    from autotest.specs.openapi.adapter.responses import OpenApiResponse
