...
def init_config(template: str, output: str, force: bool) -> None:
    ...
    click.echo("  3. Run: autotest run --config api-tester.yaml")
...
def validate_config(config_path: str) -> None:
    ...
    from autotest.yaml_config import ConfigLoader, ConfigValidationError
...
def show_config(config_path: str, env: str | None, output_format: str) -> None:
    ...
    from autotest.yaml_config import ConfigLoader
