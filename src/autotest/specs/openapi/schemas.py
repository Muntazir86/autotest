...
from autotest.core import INJECTED_PATH_PARAMETER_KEY, NOT_SET, NotSet, Specification, deserialization
from autotest.core.adapter import OperationParameter, ResponsesContainer
...
from autotest.core.failures import Failure, FailureGroup, MalformedJson
from autotest.core.jsonschema import Bundler
from autotest.core.jsonschema.bundler import BundleCache
from autotest.core.parameters import ParameterLocation
from autotest.core.result import Err, Ok, Result
from autotest.core.transport import Response
from autotest.generation.case import Case
from autotest.generation.meta import CaseMetadata
from autotest.openapi.checks import JsonSchemaError, MissingContentType
from autotest.resources import ExtraDataSource
from autotest.specs.openapi import adapter
from autotest.specs.openapi.adapter import OpenApiResponses
from autotest.specs.openapi.adapter.parameters import OpenApiParameter, OpenApiParameterSet
from autotest.specs.openapi.adapter.protocol import SpecificationAdapter
from autotest.specs.openapi.adapter.security import OpenApiSecurity, OpenApiSecurityParameters
from autotest.specs.openapi.analysis import OpenAPIAnalysis
...
if TYPE_CHECKING:
    ...
    from autotest.auths import AuthContext, AuthStorage
    from autotest.generation.stateful import APIStateMachine
...
class OpenApiSchema(BaseSchema):
    ...
    def get_all_operations(self) -> Generator[Result[APIOperation, InvalidSchema], None, None]:
        ...
        In both cases, Autotest lets the callee decide what to do with these variants. It allows it to test valid
    ...
    def find_operation_by_path(self, method: str, path: str) -> APIOperation | None:
        ...
        from autotest.specs.openapi.stateful.inference import OperationById
