...
from autotest.core.errors import InvalidStateMachine, InvalidTransition
from autotest.core.result import Ok
from autotest.core.transforms import UNRESOLVABLE
...
from autotest.generation.stateful.state_machine import APIStateMachine, StepInput, StepOutput, _normalize_name
from autotest.schemas import APIOperation
from autotest.specs.openapi.stateful.control import TransitionController
from autotest.specs.openapi.stateful.links import OpenApiLink
