...
from autotest.core.errors import InvalidTransition, OperationNotFound, TransitionValidationError, format_transition
from autotest.core.parameters import ParameterLocation
from autotest.core.result import Err, Ok, Result
from autotest.generation.stateful.state_machine import ExtractedParam, StepOutput, Transition
from autotest.schemas import APIOperation
from autotest.specs.openapi import expressions

AUTOTEST_LINK_EXTENSION = "x-autotest"
...
class OpenApiLink:
    ...
    def __init__(self, name: str, status_code: str, definition: dict[str, Any], source: APIOperation):
        ...
        extension = definition.get(AUTOTEST_LINK_EXTENSION)
