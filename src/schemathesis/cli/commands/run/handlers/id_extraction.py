...
from schemathesis.extraction.id_extractor import IDExtractor
from schemathesis.extraction.id_store import IDStore, set_id_store
...
class IDExtractionHandler(EventHandler):
    ...
    def _enable_hooks(self) -> None:
        ...
        from schemathesis.extraction import hooks as extraction_hooks
