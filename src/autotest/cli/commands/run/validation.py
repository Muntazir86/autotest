...
from autotest.config import ReportFormat, AutotestWarning, get_workers_count
from autotest.core import errors, rate_limit, string_to_boolean
from autotest.core.fs import file_exists
from autotest.core.validation import has_invalid_characters, is_latin_1_encodable
from autotest.filters import expression_to_filter_function
from autotest.generation import GenerationMode
from autotest.generation.metrics import MetricFunction
...
WARNINGS_CHOICE = CsvEnumChoice(AutotestWarning)


def validate_warnings(
    ctx: click.core.Context, param: click.core.Parameter, value: str | None
) -> bool | None | list[AutotestWarning]:
    if value is None:
        return None
