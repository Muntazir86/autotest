...
from autotest.core.transforms import UNRESOLVABLE, Unresolvable, resolve_pointer
...
class BodyResponse(Node):
    ...
    def evaluate(self, output: StepOutput) -> Any:
        from autotest.core.deserialization import DeserializationContext, deserialize_response
