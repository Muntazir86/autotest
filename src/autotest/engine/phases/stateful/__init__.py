...
from autotest.engine.phases import Phase, PhaseName, PhaseSkipReason
...
def execute(engine: EngineContext, phase: Phase) -> events.EventGenerator:
    from autotest.engine.phases.stateful._executor import execute_state_machine_loop
