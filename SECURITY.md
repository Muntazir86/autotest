...
autotest provides security updates only for the latest minor version within the 4.x series.
...
To report a security vulnerability in autotest:
...
While autotest is typically installed in test environments, we take all security reports seriously and appreciate your efforts to disclose responsibly.
