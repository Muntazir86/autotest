...
from autotest.config import InferenceAlgorithm
from autotest.core import NOT_SET, NotSet
from autotest.core.result import Ok
from autotest.core.schema_analysis import SchemaWarning
from autotest.resources import ExtraDataSource, ResourceRepository
from autotest.specs.openapi.extra_data_source import OpenApiExtraDataSource, build_parameter_requirements
from autotest.specs.openapi.resources import build_descriptors
...
from autotest.specs.openapi.warnings import (
...
if TYPE_CHECKING:
    from autotest.resources import ResourceDescriptor
