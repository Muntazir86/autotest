...
from autotest.core.jsonschema import ALL_KEYWORDS
from autotest.core.jsonschema.bundler import BUNDLE_STORAGE_KEY, bundle
from autotest.core.jsonschema.types import JsonSchema, JsonSchemaObject, get_type
...
def canonicalize(schema: dict[str, Any], resolver: RefResolver) -> Mapping[str, Any]:
    ...
    # On the Autotest side bundling solves this problem
