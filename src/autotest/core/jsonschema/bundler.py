...
from autotest.core.jsonschema.types import JsonSchema, to_json_type_name
            ...
            if isinstance(current, dict):
                ...
                if isinstance(reference, str) and not reference.startswith(REFERENCE_TO_BUNDLE_PREFIX):
                    ...
                    if inline_recursive and is_recursive_reference:
                        ...
                        # recursive references and Autotest has to remove them if possible.
                        #
                        ...
                        #
                        # To balance it, Autotest inlines one level, that avoids exponential blowup of O(B ^ L)
