...
from autotest.generation.stateful.state_machine import DEFAULT_STATEFUL_STEP_COUNT

if TYPE_CHECKING:
    from requests.structures import CaseInsensitiveDict

    from autotest.generation.stateful.state_machine import StepInput
    from autotest.specs.openapi.stateful import ApiTransitions
