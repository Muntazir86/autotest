...
from autotest.core import NOT_SET, NotSet, Specification
from autotest.core.errors import InvalidSchema, OperationNotFound
...
from autotest.hooks import HookContext, HookDispatcher, apply_to_all_dispatchers
from autotest.schemas import (
    APIOperation,
    APIOperationMap,
    ApiStatistic,
    BaseSchema,
...
def _generate_parameter(
    ...
    # Autotest does not generate anything but `body` for GraphQL, hence use `None`
