...
import autotest
from autotest.checks import CheckContext, CheckFunction
from autotest.core import media_types, string_to_boolean
from autotest.core.failures import Failure
from autotest.core.jsonschema import get_type
...
from autotest.generation.meta import CoveragePhaseData, CoverageScenario, FuzzingPhaseData
from autotest.openapi.checks import (
...
from autotest.specs.openapi.utils import expand_status_code, expand_status_codes
from autotest.transport.prepare import prepare_path

if TYPE_CHECKING:
    from autotest.schemas import APIOperation
    from autotest.specs.openapi.adapter.parameters import OpenApiParameterSet
...
def response_headers_conformance(ctx: CheckContext, response: Response, case: Case) -> bool | None:
    ...
    from autotest.specs.openapi.schemas import _maybe_raise_one_or_more
...
def _single_element_array_becomes_valid_after_serialization(case: Case) -> bool:
    ...
    """
    from autotest.specs.openapi.adapter.parameters import OpenApiParameter
...
def ignored_auth(ctx: CheckContext, response: Response, case: Case) -> bool | None:
    ...
    from autotest.specs.openapi.adapter.security import has_optional_auth
    ...
    for location, attr_name in (
        ...
        if parameter["in"] == location:
            ...
            if not isinstance(container, dict):
                container = {}
            container[name] = "Autotest-INVALID-VALUE"
