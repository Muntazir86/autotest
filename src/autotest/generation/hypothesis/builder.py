...
from autotest import auths
from autotest.auths import AuthStorage, AuthStorageMark
from autotest.config import GenerationConfig, ProjectConfig
from autotest.core import INJECTED_PATH_PARAMETER_KEY, NOT_SET, NotSet, SpecificationFeature, media_types
...
from autotest.core.parameters import LOCATION_TO_CONTAINER, ParameterLocation
from autotest.core.transforms import deepclone
from autotest.core.transport import prepare_urlencoded
from autotest.core.validation import has_invalid_characters, is_latin_1_encodable
from autotest.generation import GenerationMode, coverage
from autotest.generation.case import Case
from autotest.generation.hypothesis import examples, setup
from autotest.generation.hypothesis.examples import add_single_example
from autotest.generation.hypothesis.given import GivenInput, format_given_and_schema_examples_error
...
from autotest.hooks import GLOBAL_HOOK_DISPATCHER, HookContext, HookDispatcher, HookDispatcherMark
from autotest.schemas import APIOperation, ParameterSet
...
def create_test(
    *,
    ...
    if config.settings is not None:
        ...
        # Merge strategy:
        # - Use Autotest' config.settings as base (provides operational defaults)
        ...
        # Autotest to set its operational requirements (deadline, verbosity, etc.)
        overrides = {
...
class Template:
    ...
    def _serialize(self, kwargs: dict[str, Any]) -> dict[str, Any]:
        from autotest.specs.openapi._hypothesis import quote_all
...
def _iter_coverage_cases(
    *,
    ...
    from autotest.specs.openapi._hypothesis import _build_custom_formats
    from autotest.specs.openapi.examples import find_matching_in_responses
    from autotest.specs.openapi.media_types import MEDIA_TYPES
    from autotest.specs.openapi.schemas import OpenApiSchema
    from autotest.specs.openapi.serialization import get_serializers_for_operation
