...
def deserializer(*media_types: str) -> Callable[[ResponseDeserializer], ResponseDeserializer]:
    ...
    Example:
        ...
        >>> import msgpack
        >>>
        >>> @autotest.deserializer("application/msgpack", "application/x-msgpack")
    ...
    Notes:
        - Raise appropriate exceptions if deserialization fails; Autotest will report them
...
def deserialize_response(
    ...
    *,
    ...
    raise NotImplementedError(
        ...
        f"Register a deserializer with @autotest.deserializer() to handle this media type"
    )
