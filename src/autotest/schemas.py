...
from autotest import transport
from autotest.config import ProjectConfig
from autotest.core import NOT_SET, NotSet, media_types
from autotest.core.adapter import OperationParameter, ResponsesContainer
from autotest.core.errors import IncorrectUsage, InvalidSchema
...
from autotest.generation.hypothesis.given import GivenInput, given_proxy
from autotest.generation.meta import CaseMetadata
from autotest.hooks import HookDispatcherMark, _should_skip_hook
...
if TYPE_CHECKING:
    ...
    from autotest.auths import AuthContext
    from autotest.core import Specification
    from autotest.generation.stateful.state_machine import APIStateMachine
...
class BaseSchema(Mapping):
    ...
    def as_strategy(
        ...
        **kwargs: Any,
        ...
        Use with `@given` in non-Autotest tests.
        ...
        *,
        ...
        Args:
            response: The HTTP response to validate. Can be a `requests.Response`,
                `httpx.Response`, `werkzeug.test.TestResponse`, or `Autotest.Response`.
