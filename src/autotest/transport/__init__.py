...
from autotest.core.errors import SerializationNotPossible
...
class SerializerRegistry:
    ...
    def alias(self, target: str | list[str], source: str) -> None:
        ...
        Example:
            ...
            autotest.serializer.alias("application/custom+yaml", "application/yaml")

            # Reuse built-in JSON serializer for vendor-specific type
            autotest.serializer.alias("application/vnd.api+json", "application/json")
