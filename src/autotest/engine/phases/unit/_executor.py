...
from autotest.checks import CheckContext, run_checks
...
from autotest.generation import metrics, overrides
...
def run_test(
    *,
    ...
    try:
        ...
        # It could be an error in user-defined extensions, network errors or internal Autotest errors
        status = Status.ERROR
