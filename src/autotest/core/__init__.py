...
class SpecificationFeature(str, enum.Enum):
    """Features that Autotest can provide for different specifications."""
...
class Specification:
    ...
    def supports_feature(self, feature: SpecificationFeature) -> bool:
        """Check if Autotest supports a given feature for this specification."""
