...
from autotest.checks import CheckFunction
from autotest.core import DEFAULT_STATEFUL_STEP_COUNT
from autotest.core.errors import STATEFUL_TESTING_GUIDE_URL, NoLinksFound
...
class APIStateMachine(RuleBasedStateMachine):
    ...
    def _to_test_case(cls) -> type:
        from autotest.generation.stateful import run_state_machine_as_test
