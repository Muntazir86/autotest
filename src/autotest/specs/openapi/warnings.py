...
from autotest.specs.openapi.patterns import is_valid_python_regex
...
class MissingDeserializerWarning:
    ...
    def kind(self) -> AutotestWarning:
        ...
        return AutotestWarning.MISSING_DESERIALIZER
...
class UnusedOpenAPIAuthWarning:
    ...
    def kind(self) -> AutotestWarning:
        """The warning kind for configuration matching."""
        return AutotestWarning.UNUSED_OPENAPI_AUTH
...
class UnsupportedRegexWarning:
    ...
    @property
    def kind(self) -> AutotestWarning:
        return AutotestWarning.UNSUPPORTED_REGEX
