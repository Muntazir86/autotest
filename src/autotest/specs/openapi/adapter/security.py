...
from autotest.config import ApiKeyAuthConfig, HttpBasicAuthConfig, HttpBearerAuthConfig
from autotest.core.parameters import ParameterLocation
from autotest.generation.meta import CoveragePhaseData, FuzzingPhaseData, StatefulPhaseData
from autotest.specs.openapi.auths import ApiKeyAuthProvider, HttpBasicAuthProvider, HttpBearerAuthProvider

if TYPE_CHECKING:
    from autotest.auths import AuthContext, AuthProvider
