...
from autotest.core.jsonschema.bundler import BUNDLE_STORAGE_KEY
from autotest.core.jsonschema.keywords import ALL_KEYWORDS
...
from autotest.core import INTERNAL_BUFFER_SIZE, NOT_SET
...
from autotest.core.validation import contains_unicode_surrogate_pair, has_invalid_characters, is_latin_1_encodable
from autotest.generation import GenerationMode
from autotest.generation.hypothesis import examples
from autotest.generation.meta import CoverageScenario
from autotest.openapi.generation.filters import is_invalid_path_parameter
...
UNKNOWN_PROPERTY_KEY = "x-autotest-unknown-property"
UNKNOWN_PROPERTY_VALUE = 42
ADDITIONAL_PROPERTY_KEY_BASE = "x-autotest-additional"
