...
from autotest.specs.openapi.stateful.dependencies.resources import extract_resources_from_responses

if TYPE_CHECKING:
    from autotest.core.compat import RefResolver
    from autotest.specs.openapi.adapter.parameters import OpenApiBody
    from autotest.specs.openapi.schemas import APIOperation
