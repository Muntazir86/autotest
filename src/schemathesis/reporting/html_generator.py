"""HTML Report Generator for Schemathesis.
...
if TYPE_CHECKING:
    from schemathesis.reporting.models import TestRunInfo
...
<body>
    <div class="container">
        ...
        <!-- Footer -->
        <footer class="footer">
            <p>Generated by Schemathesis v{data.get('schemathesis_version', 'unknown')}</p>
