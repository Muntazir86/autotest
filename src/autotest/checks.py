...
from autotest.core.failures import (
    CustomFailure,
    Failure,
    FailureGroup,
    MalformedJson,
...
from autotest.core.registries import Registry
...
def load_all_checks() -> None:
    ...
    from autotest.specs.openapi.checks import status_code_conformance  # noqa: F401
...
def not_a_server_error(ctx: CheckContext, response: Response, case: Case) -> bool | None:
    ...
    from autotest.specs.openapi.utils import expand_status_codes
