...
from autotest.cli.constants import EXTENSIONS_DOCUMENTATION_URL, ISSUE_TRACKER_URL
...
def display_handler_error(handler: EventHandler, exc: Exception) -> None:
    ...
    if is_built_in:
        ...
        click.secho("\nAutotest encountered an unexpected issue.")
    ...
    if is_built_in:
        ...
        click.echo(
            f"\nFor more information on implementing extensions for Autotest CLI, visit {EXTENSIONS_DOCUMENTATION_URL}"
        )
