...
Autotest_BENCHMARK_SEED = os.environ.get("Autotest_BENCHMARK_SEED")
...
def add_single_example(
    ...
    if Autotest_BENCHMARK_SEED is not None:
        example_generating_inner_function = seed(Autotest_BENCHMARK_SEED)(example_generating_inner_function)
