...
if TYPE_CHECKING:
    ...
    from autotest.specs.graphql.schemas import GraphQLSchema


def from_asgi(path: str, app: Any, *, config: AutotestConfig | None = None, **kwargs: Any) -> GraphQLSchema:
    ...
    Example:
        ...
        app = FastAPI()
        schema = autotest.graphql.from_asgi("/graphql", app)
        ```
...
def from_wsgi(path: str, app: Any, *, config: AutotestConfig | None = None, **kwargs: Any) -> GraphQLSchema:
    ...
    Example:
        ...
        app = Flask(__name__)
        schema = autotest.graphql.from_wsgi("/graphql", app)
        ```
...
def from_url(
    ...
    Example:
        ...
        # Basic usage
        schema = autotest.graphql.from_url("https://api.example.com/graphql")

        # With authentication and timeout
        schema = autotest.graphql.from_url(
...
def from_path(
    ...
    Example:
        ...
        schema = autotest.graphql.from_path("./schema.graphql")
        ```
...
def from_file(file: IO[str] | str, *, config: AutotestConfig | None = None) -> GraphQLSchema:
    ...
    Example:
        ...
        '''
        schema = autotest.graphql.from_file(schema_sdl)

        # From file object
        with open("schema.graphql") as f:
            schema = autotest.graphql.from_file(f)
        ```
...
def from_dict(schema: dict[str, Any], *, config: AutotestConfig | None = None) -> GraphQLSchema:
    ...
    Example:
        ...
        schema = autotest.graphql.from_dict(introspection)
        ...
        schema = autotest.graphql.from_dict(response_data)
        ```
