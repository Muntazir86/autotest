...
from autotest.core.errors import AuthenticationError, IncorrectUsage
from autotest.core.marks import Mark
from autotest.core.parameters import ParameterLocation
from autotest.filters import FilterSet, FilterValue, MatcherFunc, attach_filter_chain
        ...
        *,
        ...
        if not issubclass(provider_class, AuthProvider):
            raise TypeError(
                ...
                f"See `Autotest.AuthProvider` documentation for examples."
            )
        provider: AuthProvider
...
def set_on_case(case: Case, context: AuthContext, auth_storage: AuthStorage | None) -> None:
    ...
    1. Programmatic auth (@autotest.auth())
